...
Acceptance test: a fresh Claude Code user runs `bunx @tylerjnewman/kb new research`, adds three papers, asks one question, and is told by the advisor what to do next — in under five minutes, with nothing installed but the npm package.
